...
scenario manifest (`data/scenarios/demo-university-v1.yaml`) indexes these files
through a `configRef`, and the source model (`implementation/synthetic-source-model.pdf`)
