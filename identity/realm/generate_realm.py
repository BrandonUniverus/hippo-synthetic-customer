...
def _standard_client_scopes(realm_name: str) -> list[dict[str, Any]]:
    ...
    return [
        ...
        {
            "id": _stable_id(realm_name, "client-scope", "northlake-account-console"),
            "name": "northlake-account-console",
            "description": "Internal Keycloak subject required only by the Account Console API.",
            "protocol": "openid-connect",
            "attributes": {
                "include.in.token.scope": "false",
                "display.on.consent.screen": "false",
...
def build_realm(
    ...
    realm = {
        ...
        "loginTheme": "northlake",
        "accountTheme": "northlake",
        "adminTheme": "northlake",
        "enabled": True,
        "notBefore": 0,
