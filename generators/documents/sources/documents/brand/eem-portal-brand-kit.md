...
plus a sustainability cue. It harmonizes with the existing Northlake University
...
├─ eem-portal-brand-kit.pdf      This guide
├─ eem-application-branding.pdf  The branding Northlake asked for
├─ login-customization.pdf       Ready-to-transcribe CustomLoginInfo values
├─ animations/                   Login and loading animations (animations-guide.pdf)
...
contacts, sustainability CTA) are in **`login-customization.pdf`**, formatted to
...
> in the same folder). Details in `login-customization.pdf`.
