...
an `expected_assertion` (`implementation/synthetic-source-model.pdf`). Exact numbers that
...
Sources: [bill-charge-line-spec](bill-charge-line-spec.pdf),
[phase1-substrate-extras](phase1-substrate-extras.pdf),
`data/eem/northlake-company-calendar-v1.yaml`, `data/eem/northlake-eem-permissions-v1.yaml`,
