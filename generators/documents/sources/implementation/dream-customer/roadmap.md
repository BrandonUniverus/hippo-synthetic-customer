...
Use the [packet 0.3 customer inventory](../../documents/intake-package/)
and [Student Center UI checklist](../northlake-onboarding-ui-checklist.pdf):
...
- Source-model extensions (`implementation/synthetic-source-model.pdf`) for the substrate
