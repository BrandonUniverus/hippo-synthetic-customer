...
The UI entry-path review ([entry-path-and-gaps.pdf](entry-path-and-gaps.pdf)) found
...
already specified in [phase3](phase3-ap-gl-validation-spec.pdf) (from the AP code
sweep):
